...
global SHOW_CV_DEMO CV_DEMO_DELAY
    ...
    if SHOW_CV_DEMO
        % show threshold/segmentation stage
        figure(12);
        clf;
        hold off;
        subplot(1,2,1);
    ...
    if SHOW_CV_DEMO
        % Display the final board matrix for tuning sessions
        disp(board);
    end
